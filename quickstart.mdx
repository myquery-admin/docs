...
<CardGroup cols={3}>
  ...
  <Card title="Postgres" icon="database" iconType="light" color="#c4aaaa" horizontal href="/database/sqlserver">
    
  </Card>
  <Card title="SQL Server" icon="database" iconType="light" color="#cab5b5" horizontal href="/database/sql-server">
  ...
  <Card title="NoSQL" icon="database" iconType="light" color="#cab5b5" horizontal href="/database/nosql">
...
<Note>
  <strong>Firewall allowlist</strong>
  <br />
